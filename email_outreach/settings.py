"""
Django settings for email_outreach project.
...
SECRET_KEY = "django-insecure-^8(q42mo-f33q74i^%^%81-%sg%l#3_+a+^wu3a(p$^hx8bj9n"
...
ROOT_URLCONF = "email_outreach.urls"
...
WSGI_APPLICATION = "email_outreach.wsgi.application"
